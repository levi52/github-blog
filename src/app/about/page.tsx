      ...
      <section className="flex flex-col md:flex-row gap-10 mb-16 animate-slide-in-up delay-100">
        <div className="shrink-0">
          <img
            src={profile.avatar}
            alt={profile.name}
            className="w-32 h-32 rounded-2xl border border-border hover:scale-105 hover:shadow-[var(--shadow-hover)] transition-all duration-300"
          />
        </div>
        <div className="flex-1">
          ...
          <div className="mt-6">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-text text-bg text-sm font-medium rounded-full hover:shadow-[var(--shadow-hover)] hover:scale-105 active:scale-95 transition-all duration-200"
            >
