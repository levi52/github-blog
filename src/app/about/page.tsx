...
export default function AboutPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-text text-bg text-sm font-medium rounded-full hover:opacity-90 transition-opacity"
            >
      ...
      <section>
        <h2 className="text-xl font-semibold tracking-tight mb-6">开源项目</h2>
        <div className="grid gap-4 md:grid-cols-2">
          {repos.map((repo) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-5 bg-surface border border-border rounded-xl hover:border-border-hover hover:shadow-sm transition-all duration-200"
            >
