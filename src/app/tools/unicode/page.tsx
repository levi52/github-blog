  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="bg-surface border border-border rounded-2xl p-8 animate-slide-in-up delay-100">
        <div className="mb-6">
          <h1 className="text-2xl font-bold tracking-tight mb-2">Unicode 转换</h1>
          <p className="text-sm text-text-muted">将文本转换为 Unicode 编码，或反向转换</p>
        </div>
        <UnicodeTool />
      </div>
    </div>
